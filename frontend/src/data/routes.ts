...
const rawRoutes: RawRoute[] = [
  ...
  { id: "r4", fromId: "singapore", toId: "rotterdam", chokepoint: "Malacca + Suez + Bab el-Mandeb", riskLevel: "HIGH", annualCargo: 1100 },
  ...
  { id: "r7", fromId: "verdi", toId: "toulouse", chokepoint: "European inland", riskLevel: "LOW", annualCargo: 340 },
